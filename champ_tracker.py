...
def winstealer_update(game, ui):
	...
	now = time()
	if now - t_last_save_tracks > 0.03:
	...
	for i, (pos, t) in enumerate(tracks[tracked_champ_id]):
		...
		p2= game.world_to_screen(pos)
		game.draw_circle_filled(p, 2, 4, Color(red, green, 0.0, 1.0))
		game.draw_circle_filled(p2, 6, 4, Color(red, green, 0.0, 1.0))