...
def winstealer_update(game, ui):
    ...
    for obj in game.others:
            ...
            game.draw_circle(game.world_to_screen(obj.pos),2,20,20  ,Color.RED)
            game.draw_text(game.world_to_screen(obj.pos), str(obj.id), Color.GREEN)
            
    # for minion in game.minions:
    #     if minion.is_alive:
    #         game.draw_text(game.world_to_screen(minion.pos), minion.name, Color.GREEN)
